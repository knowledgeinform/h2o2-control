...
const h2o2Ctrlr = require('./h2o2-driver.js')
...
class ControllersC {
  constructor({router, Description, Details, testFlag = true, type, index, services, serverInstance}) {
    ...
    } else if (type === 'H2O2 Driver') {
      Object.defineProperty(this, 'hidden', {
        value: new h2o2Ctrlr.Device({
          testFlag: testFlag,
          services,
          serverInstance: serverInstance,
          h2o2DriverPath: controllersPath,
          index: index,
          router: router,
        }),
      })
...
var controllersMap = {
  0: {Description: '', Details: '', 'Controller Type': {value: 'H2O2 Driver'}, index: '0'},
}
// var controllersMap = {}
