...
const pumps = require('./harvard-apparatus-70-2226.js')

const bkup = require('./backup.js')
var baseServices = [thermometers, utilities, controllers, mfc, pumps]
...
async function serviceInitialize(testFlag, thisObj) {
  ...
  try {
    await limits.initialize(testFlag, baseServices, thisObj)
    console.log('Done initializing limits')
  } catch (error) {
    console.log('limits intiailization error')
    console.log(error)
  }
  baseServices.push(limits)
